...
export default function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className={`flex flex-col items-start gap-4 `} noValidate>
      <input onChange={(e) => setEmail(e.target.value)} id="email" type="email" name="email" placeholder="user@email.com" autoComplete="off" className="px-3 py-1.5 border-[1.5px] border-textColor rounded-3xl bg-transparent placeholder:text-zinc-500 outline-none" />
