  ...
  return (
    <main className="relative h-[28rem] md:flex items-start justify-center">
      <div className={`flex items-center font-sans p-4`}>
        <div className={`flex flex-col text-3xl lg:text-5xl gap-12 z-10`}>
          ...
          <h1 className={`leading-snug font-medium`}>
            I help Independents, founders to <span>Ideate. Prototype. Build. </span>User-friendly experiences and ship it Faster.
          </h1>
        </div>
      </div>
