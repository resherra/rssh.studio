      ...
      <footer className="pt-[6rem] max-w-screen-lg lg:mx-auto flex flex-col gap-16 items-center text-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="flex gap-4">
            <a aria-label="Twitter link" href="https://twitter.com/lazycherrat" target="_blank">
              <img className="w-5" src="./images/twitter-icon.svg" alt="twitter" width="640" height="360" />
            </a>
            <a aria-label="Linkedin link" href="https://www.linkedin.com/in/redouan-cherrat-b951b81bb/" target="_blank">
              <img className="w-5" src="./images/linkedin-icon.svg" alt="linkedin" width="640" height="360" />
            </a>
            <a aria-label="Github link" href="https://github.com/lazych" target="_blank">
        ...
        <div aria-label="Copyright" className="flex gap-2 pb-4">
